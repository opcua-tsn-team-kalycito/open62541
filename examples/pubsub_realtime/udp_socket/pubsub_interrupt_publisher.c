 ...
 * ps -L -o pid,pri,%cpu -C custom_interrupt
 *
*/
...
#define             NANO_SECONDS_SLEEP              999900000
 ...
 * change in line number 40 and 41 in plugins/ua_pubsub_custom_manager.c and line number 27 in plugins/ua_pubsub_udp.c
 */
 ...
 * change in line number 670 and 673,
 * If the Hardcoded interface name need to be changed,
 * change in line number 669 and 674
...
void subscribe(void) {
     ...
     * the existing implementation in usleep*/
    usleep(20);
